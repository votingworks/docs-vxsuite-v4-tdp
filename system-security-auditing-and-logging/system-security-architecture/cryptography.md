...
* **FIPS compliance via software modules:** For all other operations, OpenSSL uses the FIPS provider. Our [OpenSSL config](https://github.com/votingworks/vxsuite-build-system/blob/v4.1.0/playbooks/trusted_build/files/openssl-3.0.9.cnf) guarantees this.
