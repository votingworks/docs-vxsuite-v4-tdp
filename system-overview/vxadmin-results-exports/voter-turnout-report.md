...
The voter turnout report shows the turnout of the election by precinct. The turnout is calculated as the number of ballots divided by the number of registered voters per precinct.
